...
default_username=${GIT_DEPLOY_USERNAME:-fbe-jgr-travis-ci}
default_email=${GIT_DEPLOY_EMAIL:-fbe-jgr-travis-ci@users.noreply.github.com}

#repository to deploy to. must be readable and writable.
#must be changed for Tracis CI because it uses the read-only git protocol
